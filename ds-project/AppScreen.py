...
def open_ls():
    ...
    listscr_path = os.path.join(parent_directory,'ds-project', 'listscr.py')

    subprocess.call(["python", listscr_path, 'Lista Sequencial'])
...
def open_lse():
    ...
    subprocess.call(["python", listscr_path, 'Lista Simplesmente Encadeada'])
...
def open_lde():
    ...
    subprocess.call(["python", listscr_path, 'Lista Duplamente Encadeada'])
...
def open_pl():
    ...
    subprocess.call(["python", treescr_path, 'Pilha'])
...
def open_fl():
    ...
    subprocess.call(["python", treescr_path, 'Fila'])
