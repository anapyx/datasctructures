...
app.buttonGoBack = cttk.CTkButton(app.frameMenu, width=200, height=50, text="Retornar", font=defaultfont, command=open_AppScreen)
app.buttonGoBack.grid(row=5, column=0, padx=20, pady=20)

label = cttk.CTkLabel(master=app, text=list_type, text_color='white')
label.configure(width=app.winfo_screenwidth(), height=100, font=titulos, pady=10, padx=20, corner_radius=10)
